 ...
 * @author roach
 */
class SectionPD2Template01Reader extends SectionPD2TemplateReader {
	...
	public SectionPD2Template01Reader(short discipline, long tsAnalysis, SectionPD2Reader base) {
		super(discipline, tsAnalysis, base, 1);
	}
}
