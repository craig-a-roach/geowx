 ...
 * @author roach
 */
class SectionPD2Template08Reader extends SectionPD2TemplateReader {
	...
	public KryptonProductDecode newProduct(KryptonDecoder d)
		...
		final ICobaltPrognosis prognosis = selectAggregate(d.validityDecoder, 35, 42);
	...
	public SectionPD2Template08Reader(short discipline, long tsAnalysis, SectionPD2Reader base) {
		super(discipline, tsAnalysis, base, 8);
	}
}
