...
import com.metservice.beryllium.BerylliumAbstractUploadHttpTracker;
import com.metservice.beryllium.BerylliumBinaryHttpPayload;

/**
 * @author roach
 */
abstract class UploadK extends BerylliumAbstractUploadHttpTracker {
	...
	protected UploadK(IBerylliumMirrorProbe probe) {
