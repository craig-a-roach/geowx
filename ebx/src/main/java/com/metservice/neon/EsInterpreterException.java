 ...
 * @author roach
 */
public class EsInterpreterException extends EsRunException
{
  public EsInterpreterException(String problem) {
    super("Interpreter Error: "+ problem);
  }
  
  public EsInterpreterException(RuntimeException cause) {
    super(cause);
  }
}
