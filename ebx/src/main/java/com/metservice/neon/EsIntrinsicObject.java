 ...
 * @author roach
 */
public final class EsIntrinsicObject extends EsObject implements IJsonObject, IJsonDeObject {
	...
	private void putProperty(String qccPropertyName, boolean allowUpdate, long value) {
	...
	public EsObject createObject() {
		return new EsIntrinsicObject(this);
	}

	@Override
	public String esClass() {
		return EsIntrinsicObjectConstructor.ClassName;
	}
	...
	public final void putUpdate(EsExecutionContext ecx, String qccPropertyName, TimeZone oValue) {
		if (oValue == null) {
			putUpdateNull(qccPropertyName);
			return;
		}
		putUpdate(qccPropertyName, ecx.global().newIntrinsicTimezone(oValue));
	}
	...
	public final void putUpdateInteger(String qccPropertyName, long value) {
		putProperty(qccPropertyName, true, value);
	}
	...
	public final void putView(EsExecutionContext ecx, String qccPropertyName, Binary oValue) {
		if (oValue == null) {
			putViewNull(qccPropertyName);
			return;
		}
		putView(qccPropertyName, ecx.global().newIntrinsicBinary(oValue));
	}
	...
	public final void putView(EsExecutionContext ecx, String qccPropertyName, TimeZone oValue) {
		...
		putView(qccPropertyName, ecx.global().newIntrinsicTimezone(oValue));
	}
	...
	public final void putViewError(Throwable ex) {
		putProperty(CProp.error, false, Ds.message(ex));
	}

	public final void putViewInteger(String qccPropertyName, long value) {
		putProperty(qccPropertyName, false, value);
	}
	...
	public final void putViewResult(IEsOperand value) {
		putView(CProp.result, value);
	}
	...
	public EsIntrinsicObject() {
	}

	public EsIntrinsicObject(EsObject prototype) {
		super(prototype);
	}
}
