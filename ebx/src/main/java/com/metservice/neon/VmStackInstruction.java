 ...
 * @author roach
 */
abstract class VmStackInstruction extends VmInstruction
{
  abstract int exec(EsExecutionContext ecx, OperandStack operandStack, int pc) throws InterruptedException;
  
  protected VmStackInstruction()
  {}
