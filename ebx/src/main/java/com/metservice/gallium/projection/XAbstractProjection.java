 ...
 * @author roach
 */
abstract class XAbstractProjection implements IGalliumProjection {
	...
	public String getProjectionDescription() {
		...
		if (this instanceof XAbstractProjectionCylindrical) {
			sb.append("cylindrical ");
		}
		if (this instanceof XAbstractProjectionConic) {
			sb.append("conic ");
		}
		if (this instanceof XAbstractProjectionPseudoCylindrical) {
			sb.append("pseudo-cylindrical ");
		}
		if (this instanceof XAbstractProjectionAzimuthal) {
			sb.append("azimuthal ");
		}
