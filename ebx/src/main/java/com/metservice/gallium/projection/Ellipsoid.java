...
class Ellipsoid {
	...
	public final static Ellipsoid CLARKE_1880 = new Ellipsoid("clrk80", 6378249.145, 0.0, 293.4663,
			"Clarke 1880 mod.");
	...
	public final static Ellipsoid INTERNATIONAL_1967 = new Ellipsoid("new_intl", 6378157.5, 6356772.2, 0.0,
			"New International 1967");
	public final static Ellipsoid GRS_1980 = new Ellipsoid("GRS80", 6378137.0, 0.0, 298.257222101,
			"GRS 1980 (IUGG, 1980)");
	public final static Ellipsoid AUSTRALIAN = new Ellipsoid("australian", 6378160.0, 6356774.7, 298.25,
			"Australian");

	public final static Ellipsoid[] ellipsoids = { SPHERE,
			new Ellipsoid("MERIT", 6378137.0, 0.0, 298.257, "MERIT 1983"),
			new Ellipsoid("SGS85", 6378136.0, 0.0, 298.257, "Soviet Geodetic System 85"), GRS_1980,
			new Ellipsoid("IAU76", 6378140.0, 0.0, 298.257, "IAU 1976"), AIRY,
			...
			new Ellipsoid("GRS67", 6378160.0, 0.0, 298.2471674270, "GRS 67 (IUGG 1967)"), BESSEL,
			new Ellipsoid("bess_nam", 6377483.865, 0.0, 299.1528128, "Bessel 1841 (Namibia)"), CLARKE_1866,
			CLARKE_1880, new Ellipsoid("CPM", 6375738.7, 0.0, 334.29, "Comm. des Poids et Mesures 1799"),
			new Ellipsoid("delmbr", 6376428.0, 0.0, 311.5, "Delambre 1810 (Belgium)"),
			new Ellipsoid("engelis", 6378136.05, 0.0, 298.2566, "Engelis 1985"), EVEREST,
			...
			new Ellipsoid("intl", 6378388.0, 0.0, 297.0, "International 1909 (Hayford)"), KRASOVSKY,
			new Ellipsoid("kaula", 6378163.0, 0.0, 298.24, "Kaula 1961"),
			new Ellipsoid("lerch", 6378139.0, 0.0, 298.257, "Lerch 1979"),
			new Ellipsoid("mprts", 6397300.0, 0.0, 191.0, "Maupertius 1738"), INTERNATIONAL_1967,
			...
			new Ellipsoid("walbeck", 6376896.0, 6355834.8467, 0.0, "Walbeck"), WGS_1960, WGS_1966, WGS_1972, WGS_1984,
